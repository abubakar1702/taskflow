    ...
    <section className="bg-white shadow p-6 rounded-xl border border-gray-200">
      ...
      <div className="space-y-4">
        {subtasks.map((subtask, index) => (
          <div key={index} className="flex flex-col gap-3 bg-white rounded-lg hover:border-gray-300 transition-all duration-200">
            <div className="flex flex-col md:flex-row gap-3">
              <div className="flex-1">
                <input
                  ...
                  className={`w-full px-3 py-2.5 border rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 ${subtask.text.length > 200 ? 'border-red-300' : 'border-gray-300'
                    }`}
                />
                <div className="flex justify-end mt-1">
                  <span className={`text-xs font-medium ${subtask.text.length > 200 ? 'text-red-600' : 'text-gray-500'}`}>
