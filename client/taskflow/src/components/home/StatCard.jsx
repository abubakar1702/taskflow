const StatCard = ({ icon, label, value, color, borderColor }) => (
    <div className={`bg-white dark:bg-slate-800 p-6 rounded-md shadow-sm border ${borderColor} dark:border-slate-700 hover:shadow-md transition-shadow flex items-start justify-between`}>
        <div>
