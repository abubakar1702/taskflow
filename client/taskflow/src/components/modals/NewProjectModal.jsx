            ...
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-3xl overflow-hidden flex flex-col max-h-[90vh] animate-fadeIn">
                ...
                <div className="p-5 border-t border-gray-100 bg-gray-50 flex justify-end gap-3">
                    ...
                    <button
                        ...
                        className={`px-5 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium shadow-sm flex items-center justify-center min-w-[140px] ${(!name.trim()) ? "opacity-50 cursor-not-allowed" : ""
                            }`}
                    >
                        {isLoading ? (
                            <>
