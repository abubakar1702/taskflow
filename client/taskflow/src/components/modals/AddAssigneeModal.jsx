            ...
            >
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                {isSelected ? (
                                                    ...
                                                    <span className="text-[9px] font-bold px-1.5 py-0.5 bg-slate-100 dark:bg-slate-800 rounded-sm text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-700 uppercase tracking-wider">
                                                        Add
                                                    </span>
                                                )}
                                            </li>
                ...
                <div className="p-6 bg-slate-50/60 dark:bg-slate-950/60 border-t border-gray-200 dark:border-slate-800 flex justify-end gap-3 rounded-b-sm">
                    ...
                    <button
                        ...
                        className="px-5 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-sm text-xs font-bold uppercase tracking-wider transition-colors border border-transparent shadow-none disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-1.5"
                    >
                        {isAdding ? (
                            <>
